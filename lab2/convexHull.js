 ...
 */
    ...
    function makeHullPresorted(points) {
        ...
        for (let i = 4; i < points.length; i = i +2) {
        ...
        let lowerHull = [points[points.length - 2], points[points.length - 1], points[points.length - 4], points[points.length - 3]];
        for (let i = points.length - 6; i >= 0; i = i -2) {
